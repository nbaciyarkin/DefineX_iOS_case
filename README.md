...
Proje .xcworkspace ile pushlanmıştır. Bir başka case gönderiminde hata yaşandığından dolayı ve firma projeyi açamadığı içn önlem olarak proje .xcworkspace ile pushlanmıştır. Projeyi .xcworkspace ile çalıştırabilirsiniz.
